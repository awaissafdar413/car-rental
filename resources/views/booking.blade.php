@extends('layout.app')
@push('title')
<title>Rentaly |My Booking </title>
@endpush
@section('content')
<!-- content begin -->
                                    ...
                                    <div class="de_form de_radio row g-3">
                                        <div class="radio-img col-lg-3 col-sm-3 col-6">
                                            <input id="radio-1a" name="Car_Type" type="radio" value="Residential"
                                                checked="checked">
                                            <label for="radio-1a"><img src="{{ asset('images/select-form/car.png') }}"
                                                    alt="">Car</label>
                                        </div>

                                        <div class="radio-img col-lg-3 col-sm-3 col-6">
                                            <input id="radio-1b" name="Car_Type" type="radio" value="Office">
                                            <label for="radio-1b"><img src="{{ asset('images/select-form/van.png') }}"
                                                    alt="">Van</label>
                                        </div>
                                        ...
                                        <div class="radio-img col-lg-3 col-sm-3 col-6">
                                            ...
                                            <label for="radio-1c"><img
                                                    src="{{ asset('images/select-form/minibus.png') }}"
                                                    alt="">Minibus</label>
                                        </div>

                                        <div class="radio-img col-lg-3 col-sm-3 col-6">
                                            <input id="radio-1d" name="Car_Type" type="radio" value="Retail">
                                            <label for="radio-1d"><img src="{{ asset('images/select-form/sportscar.png') }}"
                                                    alt="">Prestige</label>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-3 wow fadeInRight" data-wow-delay=".2s">
                    <div class="feature-box style-4 text-center">
                        ...
                        <div class="text" style="color: #1ECB15">
                            <a href="#">
                                <h4 style="color: #1ECB15">Choose a vehicle</h4>
                            </a>
                ...
                <div class="col-md-3 wow fadeInRight" data-wow-delay=".4s">
                    <div class="feature-box style-4 text-center">
                        ...
                        <div class="text" style="color: #1ECB15">
                            <a href="#">
                                <h4 style="color: #1ECB15">Pick location &amp; date</h4>
                            </a>
                ...
                <div class="col-md-3 wow fadeInRight" data-wow-delay=".6s">
                    <div class="feature-box style-4 text-center">
                        ...
                        <div class="text" style="color: #1ECB15">
                            <a href="#">
                                <h4 style="color: #1ECB15">Make a booking</h4>
                            </a>
                ...
                <div class="col-md-3 wow fadeInRight" data-wow-delay=".6s">
                    <div class="feature-box style-4 text-center">
                        ...
                        <div class="text" style="color: #1ECB15">
                            <a href="#">
                                <h4 style="color: #1ECB15">Sit back & relax</h4>
                            </a>
