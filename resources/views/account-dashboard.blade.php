                    ...
                    <div class="row">
                        <div class="col-lg-3 mb30">
                            <div class="card padding30 rounded-5">
                                ...
                                <ul class="menu-col">
                                    <li><a href="{{ route('account-dashboard',Auth::user()->id) }}" class="active"><i class="fa fa-home"></i>Dashboard</a></li>
                                    <li><a href="{{ route('profile',Auth::user()->id) }}"><i class="fa fa-user"></i>My Profile</a></li>
